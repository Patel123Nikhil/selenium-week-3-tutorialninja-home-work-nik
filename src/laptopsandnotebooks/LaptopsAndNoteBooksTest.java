...
public class LaptopsAndNoteBooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"), "Rangila");
        sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"), "Raju");
        sendTextToElement(By.xpath("//input[@id='input-payment-email']"), "test123@gmail.com");
        sendTextToElement(By.xpath("//input[@id='input-payment-telephone']"), "0345986324");
        sendTextToElement(By.xpath("//input[@id='input-payment-address-1']"), "1 Tan tana tan");
        sendTextToElement(By.xpath("//input[@id='input-payment-city']"), "London");
        sendTextToElement(By.xpath("//input[@id='input-payment-postcode']"), "BA09YD");
